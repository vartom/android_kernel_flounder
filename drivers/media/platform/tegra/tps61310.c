...
static int tps61310_param_rd(struct tps61310_info *info, long arg, bool is_compat)
{
...
static int tps61310_param_wr(struct tps61310_info *info, long arg, bool is_compat)
{
	struct nvc_param params;
	u8 val;
	int err = 0;
		...
		unsigned long arg)
{
	...
	case NVC_IOCTL32_PARAM_WR:
		return tps61310_param_wr(info, arg, true);
	case NVC_IOCTL32_PARAM_RD:
		return tps61310_param_rd(info, arg, true);
#endif
	case NVC_IOCTL_PARAM_WR:
		return tps61310_param_wr(info, arg, false);
	case NVC_IOCTL_PARAM_RD:
		return tps61310_param_rd(info, arg, false);
